...
execute if score #bw_cds bw_calc matches 1.. if score #bw_cdrop bw_calc matches ..3 if block ~ ~ ~-1 #builders_wand:gothrough positioned ~ ~ ~-1 run function builders_wand:directions/asidenez
