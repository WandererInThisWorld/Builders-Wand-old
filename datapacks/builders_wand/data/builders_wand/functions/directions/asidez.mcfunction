scoreboard players add #bw_cdropnd bw_calc 1
...
execute if score #bw_cds bw_calc matches 1.. if score #bw_cdropnd bw_calc matches ..3 if block ~ ~ ~1 #builders_wand:gothrough positioned ~ ~ ~1 run function builders_wand:directions/asidez
execute if score #bw_cdropnd bw_calc matches 4 run scoreboard players set #bw_cdropnd bw_calc 0